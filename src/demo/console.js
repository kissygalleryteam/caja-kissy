...
//                    return dt;
            ...
            log: function () { emitElement('div', toMessage(arguments), 'alert alert-info'); },
            warn: function () { emitElement('div', toMessage(arguments), 'alert alert-success'); },
            error: function () { emitElement('div', toMessage(arguments), 'alert alert-error'); },
            info: function () { emitElement('div', toMessage(arguments), 'alert alert-info'); },
            line: function () { emitElement('div', toMessage([' ']), 'line'); },
            trace: function () {}
        };
    })();
}
